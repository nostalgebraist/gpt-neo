...
def test_model():
    ...
    with not_raises(Exception):
        logits, _, _ = gpt2.model(
            features, other_features, params, mesh, variable_dtype=variable_dtype)
...
def test_mlm_sample_text():
    ...
    with not_raises(Exception):
        features, labels = mlm_sample_text(
            mlm_params, document, random_documents=True)
